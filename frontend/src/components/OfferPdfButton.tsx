...
// Проверяем валидность застройщика (исключаем URL-подобные строки)
function isValidDeveloperName(name: string | null | undefined): boolean {
  if (!name) return false;
  // Исключаем если содержит признаки URL/домена
  const urlPatterns = [

    ...
    return (
      <div className="container py-12 text-center">
        ...
        <p className="text-[var(--color-text-light)] mb-8">
          ...
          <span className="inline-flex items-center justify-center w-6 h-6 mx-1 bg-purple-100 text-purple-600 rounded">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="text-[var(--color-text-light)] hover:text-red-500 text-sm"
          >
            Очистить все
          </button>
        </div>
                  ...
                  {offers.map((offer, offerIdx) => (
                    <td
                      ...
                      className={`p-4 text-center border-b border-[var(--color-border)] ${
                        bestIdx === offerIdx ? 'bg-green-50 text-green-700 font-medium' : ''
                      }`}
                    >
                      {row.getValue(offer)}
                    </td>

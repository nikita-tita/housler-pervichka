...
test.describe('Авторизация', () => {
  ...
  test('TC-AUTH-001: Вход клиента', async ({ page }) => {
    ...
    // Проверка что авторизация прошла (проверяем наличие header с профилем или выход из login)
    // Token может храниться в cookies или localStorage под разными именами
